...
,ADQUIRIENTE
,'Ventas' as RUBRO
,SUM(ADQ_AMOUNT) as VENTAS_ADQ_MAN
,SUM(total) as VENTAS_RAPPI_MAN
,div0(VENTAS_ADQ_MAN,VENTAS_RAPPI_MAN) as CONC_MAN_VEN
,SUM(fee_calculado_Wompi) AS FEE_ADQ_MAN
,sum(fee_calculado_Wompi) as FEE_RAPPI_MAN
,div0(FEE_ADQ_MAN,FEE_RAPPI_MAN) AS CONC_MAN_FEE
,SUM(ADQ_IVA_AMOUNT+ADQ_RETEIVA_AMOUNT+ADQ_RETEICA_AMOUNT+ADQ_RETEFUENTE_AMOUNT) as TAX_ADQ_MAN
